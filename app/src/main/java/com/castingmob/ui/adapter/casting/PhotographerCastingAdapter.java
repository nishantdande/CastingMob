...
public class PhotographerCastingAdapter extends RecyclerView.Adapter<PhotographerCastingAdapter.ViewHolder> {

    private static final PhotographerCastingAdapter feedAdapter = new PhotographerCastingAdapter();

    PhotographerCastingAdapter(){}

    public static PhotographerCastingAdapter getInstance() {
        return feedAdapter;
    }
