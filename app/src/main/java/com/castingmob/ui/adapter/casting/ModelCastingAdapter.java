...
public class ModelCastingAdapter extends RecyclerView.Adapter<ModelCastingAdapter.ViewHolder> {

    private static final ModelCastingAdapter feedAdapter = new ModelCastingAdapter();

    ModelCastingAdapter(){}

    public static ModelCastingAdapter getInstance() {
        return feedAdapter;
    }
