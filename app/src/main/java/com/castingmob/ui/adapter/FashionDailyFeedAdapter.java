...
public class FashionDailyFeedAdapter extends RecyclerView.Adapter<FashionDailyFeedAdapter.ViewHolder> {

    private static FashionDailyFeedAdapter feedAdapter = new FashionDailyFeedAdapter();

    FashionDailyFeedAdapter(){}

    public static FashionDailyFeedAdapter getInstance() {
        return feedAdapter;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        if (rssItems != null && rssItems.size()>0) {
            ...
            try {
                holder.desp.setText(XmlParserUtility.parserFWDTag(rssItem.getDescription()));
