...
public class ModelsComFeedAdapter extends RecyclerView.Adapter<ModelsComFeedAdapter.ViewHolder> {

    private static ModelsComFeedAdapter feedAdapter = new ModelsComFeedAdapter();

    ModelsComFeedAdapter(){}

    public static ModelsComFeedAdapter getInstance() {
        return feedAdapter;
    }
