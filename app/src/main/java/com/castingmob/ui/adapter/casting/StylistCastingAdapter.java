...
public class StylistCastingAdapter extends RecyclerView.Adapter<StylistCastingAdapter.ViewHolder> {

    private static final StylistCastingAdapter feedAdapter = new StylistCastingAdapter();

    StylistCastingAdapter(){}

    public static StylistCastingAdapter getInstance() {
        return feedAdapter;
    }
