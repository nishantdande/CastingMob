...
public class MUAsCastingAdapter extends RecyclerView.Adapter<MUAsCastingAdapter.ViewHolder> {

    private static final MUAsCastingAdapter feedAdapter = new MUAsCastingAdapter();

    MUAsCastingAdapter(){}

    public static MUAsCastingAdapter getInstance() {
        return feedAdapter;
    }
