...
import com.castingmob.ui.adapter.TabDividerItemDecoration;

public class CastingTabRecycleView extends RecyclerView {
    ...
    public CastingTabRecycleView(Context context) {
        this(context, null);
    }

    public CastingTabRecycleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        ItemDecoration itemDecoration = new TabDividerItemDecoration(context, DividerItemDecoration.VERTICAL_LIST);
