...
public class ProfileUpdateContainerFragment extends BaseFragment {

    private OpeningScreenActivity homeScreenActivity;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        EventBus.getDefault().register(ProfileUpdateContainerFragment.this);
    }
    ...
    public void onAttach(Context context) {
        ...
        homeScreenActivity = ((OpeningScreenActivity) context);
    }
    ...
    public void onEvent(EventManager event){
        // your implementation
        if (event != null && event.getProfileUpdateActivity() != null){
            switch (event.getProfileUpdateActivity()){
                case PROFILE_INFO:
                    mFeedViewPager.setCurrentItem(0);
                    break;
    ...
    private void setupViewPager(NonSwipeableViewPager viewPager) {
        ...
        adapter.addFragment(SignUpInfoFragment.createFragment(), "");
        adapter.addFragment(SignUpEditStatsFragment.createFragment(), "");
    ...
    public void onDestroy() {
        super.onDestroy();
        EventBus.getDefault().unregister(ProfileUpdateContainerFragment.this);
    }
}
