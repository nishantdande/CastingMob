...
import com.castingmob.ui.adapter.feeds.PhotographerAdapter;
...
public class PhotographerFragment extends BaseFragment  {
    ...
    private static PhotographerFragment modelsFragment;

    public static PhotographerFragment createFragment() {
        if (modelsFragment == null) {
            modelsFragment = new PhotographerFragment();
        }
        return modelsFragment;
    }

    private PhotographerAdapter feedAdapter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        EventBus.getDefault().register(PhotographerFragment.this);
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        EventBus.getDefault().unregister(PhotographerFragment.this);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        feedAdapter = PhotographerAdapter.getInstance();
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        Log.d("HomeScreen", "Photographer "+isVisibleToUser);
        if (isVisibleToUser) {
    ...
    private void getFeedsV2(){
        Filter.getFilter().setUserSubType("photographer");
