...
import com.castingmob.ui.adapter.feeds.StylistAdapter;
...
public class StylistsFragment extends BaseFragment  {

    private static StylistsFragment modelsFragment;

    public static StylistsFragment createFragment() {
        if (modelsFragment == null) {
            modelsFragment = new StylistsFragment();
        }
        return modelsFragment;
    }

    private StylistAdapter feedAdapter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        EventBus.getDefault().register(StylistsFragment.this);
    }

    @Subscribe
    // This method will be called when a HelloWorldEvent is posted
    public void onEvent(ModelsFragment.LocationBradcast event){
    ...
    public void onDestroy() {
        super.onDestroy();
        EventBus.getDefault().unregister(StylistsFragment.this);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        feedAdapter = StylistAdapter.getInstance();
    ...
    private void getFeedsV2(){
        Filter.getFilter().setUserSubType("stylist");
        Filter.getFilter().setUserType("client");
        FeedManager.getInstance().getFeedsV2(Filter.getFilter(), new Callback<Feeds>() {
            @Override
    ...
    CastingRecycleView.OnItemClickListener onItemClickListener
        ...
        public void onItemClick(View view, final int position) {
            ...
            ImageView feed = (ImageView) view.findViewById(R.id.feed);
    ...
    private void getFeeds(Filter filter){
        FeedManager.getInstance().getFeeds(filter, new Callback<List<FeedItem>>() {
            /**
             * Invoked for a received HTTP response.
             * <p/>
             * Note: An HTTP response may still indicate an application-level failure such as a 404 or 500.
