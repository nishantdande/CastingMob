...
import com.castingmob.ui.adapter.ModelsComFeedAdapter;
...
public class ModelsComFeedTab extends BaseFragment {

    private static ModelsComFeedTab feedTabs = null;

    private static int tabPosition = -1;

    @Bind(R.id.feeds)
    CastingTabRecycleView mFeedList;
    private ModelsComFeedAdapter modelsComFeedTab;

    // factory method for Led Fragment to create instance of LED fragment
    public static ModelsComFeedTab createFragment(int tabPosition) {
        feedTabs = new ModelsComFeedTab();
        return feedTabs;
    }
    ...
    private void fetchRssFeed() {
        ...
        Call<ResponseBody> items = rssAdapter.getModelItems();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        modelsComFeedTab = ModelsComFeedAdapter.getInstance();
        mFeedList.setAdapter(modelsComFeedTab);
    ...
    private void refreshFeeds(List<RSSItem> feedItems) {
        modelsComFeedTab.setFeeds(getActivity(), feedItems);
    }
}
