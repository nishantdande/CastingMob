...
import com.castingmob.ui.adapter.feeds.MUAsAdapter;
...
public class MUAsFragment extends BaseFragment {

    private static MUAsFragment modelsFragment;

    public static MUAsFragment createFragment() {
        if (modelsFragment == null) {
            modelsFragment = new MUAsFragment();
        }
        return modelsFragment;
    }

    private MUAsAdapter feedAdapter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        EventBus.getDefault().register(MUAsFragment.this);
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        EventBus.getDefault().unregister(MUAsFragment.this);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        feedAdapter = MUAsAdapter.getInstance();
    ...
    private void getFeedsV2(){
        Filter.getFilter().setUserSubType("makeupartist");
