...
public class UpdatePolaroidPhotoScreenFragment extends BaseFragment {
...
//        - See more at: http://www.theappguruz.com/blog/android-take-photo-camera-gallery-code-sample#sthash.fD2nNIRu.dpuf
    ...
    private void uploadCoverPhoto(String destination){
        progressView.show();
        AccountManager.getInstance().uploadPolaroidPhoto(Profile.getInstance().getToken(), destination, new Callback<PhotoItem>() {
            /**
