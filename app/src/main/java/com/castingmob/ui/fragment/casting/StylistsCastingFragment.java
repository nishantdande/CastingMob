...
import com.castingmob.casting.collection.StylistsCriteria;
...
import com.castingmob.ui.adapter.casting.StylistCastingAdapter;
...
public class StylistsCastingFragment extends BaseFragment implements NewHomeScreenActivity.onFilterChangeListener {

    private static StylistsCastingFragment modelsFragment;

    public static StylistsCastingFragment createFragment() {
        if (modelsFragment == null) {
            modelsFragment = new StylistsCastingFragment();
        }
    ...
    StylistCastingAdapter searchCastingAdapter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        EventBus.getDefault().register(StylistsCastingFragment.this);
    }
    ...
    public void onEvent(EventManager event) {
        ...
        if (event.getObject() instanceof Filter){
            if (castingItems != null) {
                Criteria stylistCasting = new StylistsCriteria();
                refreshCastings(stylistCasting.meetCriteriaByLocation(castingItems, Filter.getFilter()));
            }
        }
        else if (event.getCastingItems() != null) {
            castingItems = event.getCastingItems();
            Criteria stylistCasting = new StylistsCriteria();
            refreshCastings(stylistCasting.meetCriteria(event.getCastingItems()));
        }
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        searchCastingAdapter = StylistCastingAdapter.getInstance();
    ...
    public void onDestroy() {
        super.onDestroy();
        EventBus.getDefault().unregister(StylistsCastingFragment.this);
    }
