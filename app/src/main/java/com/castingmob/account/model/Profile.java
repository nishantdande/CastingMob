...
public class Profile {
    ...
    public String getGender(Profile.Gender gender){
        if (gender != null){
            switch (gender){
                case male:
                    return "Male";
    ...
    public void setProfile(Profile profileObj){
        if (profileObj != null)
            profile = profileObj;
    }

    public Profile(String token, String firstName, String lastName,
                   String displayName, Gender gender, String dateOfBirth,
